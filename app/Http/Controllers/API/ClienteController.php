...
class ClienteController extends BaseController
{
    public function store(Request $request){
        ...
        if($validator->fails()){
            ...
            $input = $request->all();
            $input['dui_hash'] = Hash::make($input['dui']);
            $input['nit_hash'] = Hash::make($input['nit']);
            $input['email_hash'] = Hash::make($input['email']);
            $input['telefono_hash'] = Hash::make($input['telefono']);
